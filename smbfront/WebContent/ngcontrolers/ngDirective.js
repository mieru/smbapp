app.directive('kategorie',["$location", function($location) {
	 return {templateUrl: "kategorieOfertaMenu.html"};
}]);

app.directive('fakturatable',[function() {
	 return {templateUrl: "fakturaTable.html" };
}]);

app.directive('zgloszeniatable',[function() {
	 return {templateUrl: "zgloszeniaTable.html"};
}]);

app.directive('zamowienietable',[function() {
	 return {templateUrl: "zamowienieTable.html"};
}]);
