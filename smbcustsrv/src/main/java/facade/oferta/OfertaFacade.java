...
import query.restaction.oferta.OfertaRequestData;
...
public class OfertaFacade {
	...
	public String getOferta(OfertaRequestData ofertaRequestData) throws JSONException, IOException {
		JSONArray jsonArray = new JSONArray();
		Integer idKat = null;
		KategoriaTowar kategoriaTowar = null;
		List<Towar> towarList = null;
		if(ofertaRequestData.kategoria != null){
			idKat = Integer.parseInt(ofertaRequestData.kategoria);
