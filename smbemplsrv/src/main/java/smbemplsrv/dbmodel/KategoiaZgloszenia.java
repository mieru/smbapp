...
public class KategoiaZgloszenia implements Serializable {
	...
	@Column(name="czy_klient")
	private Boolean czyKlient;

	@Column(name="czy_magazyn")
	private Boolean czyMagazyn;
	...
	public Boolean getCzyKlient() {
		return this.czyKlient;
	}

	public void setCzyKlient(Boolean czyKlient) {
		this.czyKlient = czyKlient;
	}

	public Boolean getCzyMagazyn() {
		return this.czyMagazyn;
	}

	public void setCzyMagazyn(Boolean czyMagazyn) {
		this.czyMagazyn = czyMagazyn;
	}
