...
public class Towar implements Serializable {
	...
	@Column(name="czy_stan_sys")
	private Boolean czyStanSys;

	@Column(name="czy_stan_uzyt")
	private Boolean czyStanUzyt;
	...
	public Boolean getCzyStanSys() {
		return this.czyStanSys;
	}

	public void setCzyStanSys(Boolean czyStanSys) {
		this.czyStanSys = czyStanSys;
	}

	public Boolean getCzyStanUzyt() {
		return this.czyStanUzyt;
	}

	public void setCzyStanUzyt(Boolean czyStanUzyt) {
		this.czyStanUzyt = czyStanUzyt;
	}
